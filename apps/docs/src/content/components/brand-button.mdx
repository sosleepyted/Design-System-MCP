...
guidelines:
  do:
    - "Lead a section with one yellow primary CTA."
    - "Use GlowButton for the signature conversion action."
  dont:
    - "Place two competing yellow CTAs side by side."
...
import { BrandButton, Icon } from "@ucm/ui";
...
| Android  | -         | -                              |
| iOS      | -         | -                              |
| Web      | <Icon name="check_circle" /> | `@ucm/ui` → `BrandButton`, `GlowButton` |
