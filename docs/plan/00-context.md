...
> Save this as `CLAUDE.md` at the repo root (or paste it first in your Claude Code
> session). Every step prompt assumes you have this context. Paste steps one at a
> time and stop to verify at the end of each before pasting the next.
